...
float timer; // Переменная для подсчета времени сортировки
...
time_t stop = clock(); // Кладем в stop нынешнее время 
timer = (stop - start) / 10000.0; // Рассчитываем время сортировки в секундах; 
